/**
 * Realm Profitability Page Component
 * 
...
export default function RealmProfitability() {
  ...
  const exportToCSV = () => {
    ...
    const rows = sortedData.map((item, index) => {
      ...
      return [
        ...
        rpbr,
        ecpm.toFixed(2),
        calculateMargin(item.network_operations_price_advertiser, item.network_operations_price_publisher).toFixed(2),
    ...
    link.setAttribute('download', `realm-profitability-${new Date().toISOString().split('T')[0]}.csv`);
